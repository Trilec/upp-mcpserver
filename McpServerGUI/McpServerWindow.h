...
public:
    ...
    void OnStartServer(); void OnStopServer();
...
private:
    void MenuAction(); void ShowToolsPanel(); void ShowConfigPanel();
    void ShowPermsPanel(); void ShowSandboxPanel(); void ShowLogsPanel();
    void AddSandboxRootAction(); void RemoveSandboxRootAction(); void ClearLogsAction();
    void ToolEnableAction(); void ToolDisableAction();
    void UpdateConfigFromPortEdit(); void UpdateConfigFromBindList(); void UpdateConfigFromMaxLogSize();
    void SyncConfigToUI(); void SyncUIToConfig();
    void RefreshToolLists(); void RefreshSandboxList(); void RefreshPermissionCheckboxes();
    void RefreshLogConfig(); void UpdateStatusDisplay();
